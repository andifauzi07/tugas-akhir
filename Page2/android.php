...
if ( !isset($_SESSION["login"]) ) {
	...
	if (isset($_POST["kirim"]) ){
		...
		$query = "INSERT INTO app VALUES ('','$nama','$no','$email','$pesanan'); ";
	...
	<body>
		...
		<div class="hero">
			<div class="jumbotron text-center">
				<h1 class="display-4">Android Developer</h1>
				<p>Buat Aplikasi pribadi menarik dan aman</p>
				<p class="lead">Buat Android Appmu sekarang, dengan mengklik tombol di bawah ini</p>
				<a
					...
					<div class="col-md-6 mt-2">
						<form action="" method="post">
							...
							<div class="mb-3">
								...
								<button
									id="loading"
									class="btn btn-dark mt-4 d-none"
									type="button"
									disabled>
									<span
