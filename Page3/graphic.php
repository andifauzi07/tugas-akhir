<?php
	...
	if (isset($_POST["kirim"]) ){
		...
		$query = "INSERT INTO graphic VALUES ('','$nama','$no','$email','$pesanan'); ";
	...
	<body>
		...
		<div class="hero">
			<div class="jumbotron text-center">
				...
				<p>Buat Graphic Design sesuka mu</p>
				<p class="lead">Buat Desain Grafismu sekarang, dengan mengklik tombol di bawah ini</p>
				<a
